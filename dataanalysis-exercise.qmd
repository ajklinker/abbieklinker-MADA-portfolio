...
### Step 1: Load and Viewing the Tobacco R data

```{r}

 load("~/Documents/MADA 2023/abbieklinker-MADA-portfolio/AK_tobacco.RData")
...
sorted_data<- top_n(t_tall_NS_2000,5,Rate) %>% subset(select=c(State,Year,Rate))
